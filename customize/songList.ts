...
export const songList = [
    {
        'id': 1,
        'anime': '3D Music',
        'name': '"Ori" by 3D Music',
        'video': 'https://www.youtube.com/watch?v=tf-ACGTOQ5s',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=tf-ACGTOQ5s'
    },
    {
        'id': 2,
        'anime': 'Ado',
        'name': '"Love me forever!" by Ado',
        'video': 'https://www.youtube.com/watch?v=TPMdLG7LO-4',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=TPMdLG7LO-4'
    },
    {
        'id': 3,
        'anime': 'Alice Gear Aegis',
        'name': '"Universal Whisper" by Masumi Tazawa',
        'video': 'https://www.youtube.com/watch?v=d3ULuUAB60U',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=d3ULuUAB60U'
    },
    {
        'id': 4,
        'anime': 'anemoi',
        'name': '"Kazayui" by Yuiko Oohara',
        'video': 'https://file.garden/aeT90aiUoRzyQ9xT/%E9%A2%A8%E7%B5%90%20-kazayui-%20(webm).mp4',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=fyg9SW4Dwpk'
    },
    {
        'id': 5,
        'anime': 'Bubble',
        'name': '"Shikisai" by Riria.',
        'video': 'https://www.youtube.com/watch?v=ihYk0_0Gm5I',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=ihYk0_0Gm5I'
    },
    {
        'id': 6,
        'anime': 'BUMP OF CHICKEN',
        'name': '"Bouen no March" by BUMP OF CHICKEN',
        'video': 'https://www.youtube.com/watch?v=Fk4sgvvHyeI',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=Fk4sgvvHyeI'
    },
    {
        'id': 7,
        'anime': 'CorLeonis × ABSOLUTE CASTAWAY',
        'name': '"White Impulse" by Nagi Yanagi & Mitsuki Nakae',
        'video': 'https://www.youtube.com/watch?v=7BVCYKEcCmk',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=7BVCYKEcCmk'
    },
    {
        'id': 8,
        'anime': 'DJ Genki feat. yukacco',
        'name': '"Hoshizora Memory" by DJ Genki feat. yukacco',
        'video': 'https://www.youtube.com/watch?v=Y9AjpE7NwPg',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=Y9AjpE7NwPg'
    },
    {
        'id': 9,
        'anime': 'EastNewSound',
        'name': '"Victim" by Hotaru Murasaki',
        'video': 'https://www.youtube.com/watch?v=fhhu-W9pKHc',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=BHOZcNqarJc'
    },
    {
        'id': 10,
        'anime': 'eill',
        'name': '"Succubus" by eill',
        'video': 'https://www.youtube.com/watch?v=7_jqyNHeNdM',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=7_jqyNHeNdM'
    },
    {
        'id': 11,
        'anime': 'FloweRiЯy',
        'name': '"Cyclamen ni Soyokaze o" by FloweRiЯy',
        'video': 'https://www.youtube.com/watch?v=I8Eh20HpXtM',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=qAZrPvrWJAE'
    },
    {
        'id': 12,
        'anime': 'Forticus',
        'name': '"Trinity Force" by Masami Okui×Yuki Tanaka',
        'video': 'https://www.youtube.com/watch?v=BJAkrCYk3Lo',
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=1HzPft5Gb0w'
    },
    {
        'id': 13,
    ...
    },
    {
        ...
        'mp3': null,
        'full': 'https://www.youtube.com/watch?v=s1gMPzdSOAs'
    }
] satisfies Song[];
